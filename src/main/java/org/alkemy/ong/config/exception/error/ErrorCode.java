...
public enum ErrorCode {
    ...
    TOKEN_INVALID_OR_EXPIRED("The server cannot return a response due to an invalid token or token expired."),
    ...
    ROLE_INVALID("The server cannot return a response due to an invalid role");
